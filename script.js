const translations = {
  es: {
    ...
    topService: "Domingo 10:30 AM MT",
    topPhone: "(620) 384-8630",
    navHome: "Inicio",
    navAbout: "Nosotros",
    ...
    worshipTime: "10:30 AM MT",
    worshipDesc: "Predicación bíblica, oración, alabanza y comunión como iglesia.",
    studyDay: "Miércoles",
    studyTitle: "Escuela bíblica",
    studyTime: "7:00 PM MT",
    studyDesc: "Clases bíblicas para aprender, hacer preguntas y crecer en la fe.",
    familyDay: "Viernes",
    familyTitle: "Noche de oración",
    familyTime: "7:00 PM MT",
    familyDesc: "Un tiempo dedicado a buscar a Dios y orar por la iglesia, las familias y la comunidad.",
    ...
    visitServiceTitle: "Domingo a las 10:30 AM MT",
    visitServiceText:
      "Los horarios están en Mountain Time. Agrega aquí la dirección completa, instrucciones de estacionamiento y cualquier detalle importante para visitantes.",
    ...
    contactPhoneValue: "(620) 384-8630",
    ...
    footerVisitTitle: "Visítanos",
    footerVisitText: "Domingos 10:30 AM MT",
    footerPrayerText: "Miércoles y viernes 7:00 PM MT",
    footerContactTitle: "Contacto",
    footerAddress: "Dirección por agregar",
  ...
  en: {
    ...
    studyDay: "Wednesday",
    studyTitle: "Bible School",
    studyTime: "7:00 PM MT",
    studyDesc: "Bible classes to learn, ask questions, and grow in faith.",
    familyDay: "Friday",
    familyTitle: "Prayer Night",
    familyTime: "7:00 PM MT",
    familyDesc: "A dedicated time to seek God and pray for the church, families, and the community.",
    ...
    visitServiceTitle: "Sunday at 10:30 AM MT",
    visitServiceText:
      "Times are listed in Mountain Time. Add the full address, parking instructions, and any important details for visitors here.",
    ...
    footerVisitText: "Sundays 10:30 AM MT",
    footerPrayerText: "Wednesdays and Fridays 7:00 PM MT",
    footerContactTitle: "Contact",
    footerAddress: "Address to be added",
